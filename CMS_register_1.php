...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6f94d3ebe813bff2966416af49e4bc8d">
    </script>
</head>
<style>
.idChecked2,
...
<body>
    <script>
    //20240723 - 아이디입력란 숫자입력 안됨, 기존 아래 "fn_press_han(obj) " 이하 주석처리함
    function fn_press_han(obj) { //cms 꺼 가져옴
        //좌우 방향키, 백스페이스, 딜리트, 탭키에 대한 예외
        if (event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 37 || event.keyCode == 39 ||
            event.keyCode == 46) return;
        obj.value = obj.value.replace(/[\ㄱ-ㅎㅏ-ㅣ가-힣]|[~!@#$%^&*()_+|()]/g, '');

        // 영문 대소문자와 숫자만 허용 (^는 반대개념 -이외의)- 사실은 아이디체크는 이게 적합함.
    ...
    */
    ...
    <div class="container-fluid mt-5" style="text-align: center;">
        <h1 style="font-size : 2em; margin-top: 0; font-weight: bold;"><span
                style="color: #FF5222; font-weight: 900;">CAP AI지문솔루션</span> 회원가입</h1>
        <div class="container">
            <div class="row">
            ...
            <form name="join" action="BNS_registerDB.php" method="post">
                ...
                <table class="table table-bordered" style="margin-top:0; border-bottom: solid red;">
                    ...
                    <tr>
                        ...
                        <td colspan=3>
                            ...
                            <span class="my-3 text-muted" style="margin-top: 50px;">e-mail은 아이디와 비밀번호 찾기에 사용됩니다. 정확하게
                                입력해 주세요.</span>
                        </td>
                    </tr>
                    <!-- 소속 삭제
                <tr>
                        ...
                        <td><div class = "row">
                                ...
                                <input type="button" value="소속찾기" class="btn btn-outline-info" style = "width: 20%; float: none; margin: 0 auto;" onclick="check_sch();" />
                            </div>
                        </td>
                    </tr>
                    -->
                ...
                <div class="formCheck">
                    ...
                    <!-- <input type="hidden" name="inputChecked" class="inputChecked" /> -->
                </div>
        </div>
...
<div class="row">
    <!--<img style="width: 100%; height: 100px; margin-top: 24px; image-rendering: -webkit-optimize-contrast;" src="img/tail.png" alt="" />-->
</div>
