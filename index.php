...
<!--						<i class="fa fa-hashtag me-2"></i>-->
						<span style="color: #FD4827;">CAP</span> AI Fingers</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4" >
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/<?echo $img ?>.png" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0"><?echo $result5['name'] ?>&nbsp;<?echo $job ?>님</h6>
                        <span>반갑습니다.</span>
                    </div>
                </div>
				<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link active" style=""><i class="fa fa-home me-2"></i>첫 화면</a>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <div class="nav-item dropdown">r
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>보고확인 및 인쇄</a>
                         <div class="dropdown-menu bg-transparent border-0">
                            <a href="fp_err.html" class="dropdown-item">검사 오류 지원</a>
                            <a href="#" class="dropdown-item">검색 기록</a>
                            <a href="#" class="dropdown-item">컨설턴트 관리</a>
                            <a href="#" class="dropdown-item">문의 확인</a>
                        </div>
                    </div>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-cart-arrow-down me-2"></i>검사 구매</a>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-comments-o me-2"></i>컨설턴트 지원</a>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-folder-open-o me-2"></i>프로그램 소개</a>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-cogs me-2"></i>관리페이지 소개</a>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-commenting me-2"></i>FAQ</a>
					<div class="navbar-nav w-100 mb-1" style="border-bottom-style: ridge;"></div>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-envelope-o me-2"></i>문의하기</a>
...
-->
				...
				<script>
//											function reloadDivArea5() {
//						var currentLocation = window.location;
//						$("#divReloadLayer5").load(' #divReloadLayer5');
//			}	
					...
					<div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle navstlye" data-bs-toggle="dropdown" >
							<div class="position-relative" id="divReloadLayer9">
								<img class="rounded-circle" src="img/<?echo $img2 ?>" alt="" style="width: 40px; height: 40px;">
								<div class="<?php if($img2 == 'user.jpg'){ ?>bg-danger <?}else{?> bg-success <?}?> rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
							</div>
					...
					<div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle navstlye" data-bs-toggle="dropdown" >
							<div class="position-relative" id="divReloadLayer8">
								<img class="rounded-circle" src="img/<?echo $img3 ?>" alt="" style="width: 40px; height: 40px;">
								<div class="<?php if($img3 == 'user.jpg'){ ?>bg-danger <?}else{?> bg-success <?}?> rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
							</div>
					...
					<div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle navstlye" data-bs-toggle="dropdown" >
							<div class="position-relative" id="divReloadLayer7">
								<img class="rounded-circle" src="img/<?echo $img4 ?>" alt="" style="width: 40px; height: 40px;">
								<div class="<?php if($img4 == 'user.jpg'){ ?>bg-danger <?}else{?> bg-success <?}?> rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
							</div>
                    ...
                    <div class="nav-item dropdown">
						...
						<?php	
						  ...
						  $result2 = $stmt->fetch();
						   ?>
<!--							<div id="">-->
							<i class="fa me-lg-2" style="background: radial-gradient( #beebfd 10%, red 100px, brown 99% );position: absolute;width: 18px;height: 18px;margin: 22px 0 0 -23px;box-shadow: 1px 1px gray;color: #ed4d4d;" ><span id="divReloadLayer5"><?echo $result2['comment_counter']?></span></i>
<!--							<div style="width: 100px;background-color: #131313;" ></div>-->
                            <span class="d-none d-lg-inline-flex">오류지원 &nbsp;<span style="color: red;" ><?echo $result2['comment_counter']?></span>명 </span>
								</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0" style="height: 300px; overflow: auto">
...
?>
							...
							<a href="fp_err.html?user_code=<?echo $result1['user_code']?>&user_name=<?echo $result1['user_name']?>&birth=<?echo $result1['birth']?>&handle=<?echo $result1['handle']?>&gender=<?echo $result1['gender']?>" class="dropdown-item">
                                <h6 class="fw-normal mb-0"><?echo $result1['user_name'] ?>님</h6>
								
								
<!--                                <small><?echo $result['error'] ?></small>-->
								<small>오류지원 <?echo $result3['counter'] ?> 건</small>
                            </a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="img/<?echo $img ?>.png" alt="" style="width: 40px; height: 40px;">

							
							
							<span class="d-none d-lg-inline-flex"> <?echo $result5['name'] ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item"><i class="fa fa-user-circle" style="padding-right: 8px;"></i>프로필</a>
<!--                            <a href="#" class="dropdown-item"></a>-->
                            <a href="adminLogout.php" class="dropdown-item"><i class="fa fa-sign-out" style="padding-right: 8px;"></i>로그아웃</a>
                        </div>
                    </div>
...
<script>
	...
	setInterval('reloadDivArea()', 1000); //30초 후 새로고침
            ...
            <div class="container-fluid pt-4 px-4 mb-5">
                ...
                <div class="bg-light text-center rounded p-1" id="divReloadLayer" style="background-color: white !important;">
                    ...
                    <div class="table-responsive">
                        ...
                        while($board = $stmt->fetch()){
							  ...
							  $result7 = $stmt2->fetch(); ?>
                                ...
                                <tr style="<?php if($result7['user_code'] == $board['user_code']){ ?> background-color: #8B98BD; color: white;<?}else if($board['finger_type'] == ""){?> background-color: #D3D3D3; <?}?>">
                                    <td><input class="form-check-input" type="checkbox"></td>
                                    <td><?echo $board['date']?></td>
                                    <td><?echo $board['finger_type']?></td>
                                    <td><?echo $board['user_name']?></td>
                                    <td><?echo $board['handle']?></td>
                                    <td><?echo $board['user_code']?></td>
                                    <td><?echo $board['member_code']?></td>
                                    <td>
...
<!--
                                    <td style="<?php if($board['support'] != ""){ if($result7['user_code'] != ""){?>background-color: #EE643C; <?}else{?>background-color: #3ED730; color: white;<?}}?>"><?echo $board['support']?></td>
                                    <td style="<?php if($board['support2'] != ""){ if($result7['user_code'] != ""){?>background-color: #EE643C; <?}else{?>background-color: #3ED730; color: white;<?}}?>"><?echo $board['support2']?></td>
                                    <td style="<?php if($board['support3'] != ""){ if($result7['user_code'] != ""){?>background-color: #EE643C; <?}else{?>background-color: #3ED730; color: white;<?}}?>"><?echo $board['support3']?></td>
-->
									
									<td style="<?php if($board['support'] != ""){ if($board['support'] == "" || $board['support2'] == "" || $board['support3'] == ""){?>background-color: #EE643C;color: white; <?}else{?>background-color: #3ED730; color: white;<?}}?>"><?echo $board['support']?></td>
                                    <td style="<?php if($board['support2'] != ""){ if($board['support'] == "" || $board['support2'] == "" || $board['support3'] == ""){?>background-color: #EE643C;color: white; <?}else{?>background-color: #3ED730; color: white;<?}}?>"><?echo $board['support2']?></td>
                                    <td style="<?php if($board['support3'] != ""){ if($board['support'] == "" || $board['support2'] == "" || $board['support3'] == ""){?>background-color: #EE643C;color: white; <?}else{?>background-color: #3ED730; color: white;<?}}?>"><?echo $board['support3']?></td>
                                </tr>
                                ...
                                while($board = $stmt->fetch()){
                                      ...
                                      $result7 = $stmt2->fetch(); ?>
                                        ...
                                        <tr style="<?php if($result7['user_code'] == $board['user_code']){ ?> background-color: #8B98BD; color: white;<?}else if($board['finger_type'] == ""){?> background-color: #D3D3D3; <?}?>">
                                            ...
                                            <td><?echo $board['user_code']?></td>
                                            <td><?echo $board['member_code']?></td>
                                            <td><a class="btn btn-sm btn-primary" href="fp_err.html?user_code=<?echo $board['user_code']?>&user_name=<?echo $board['user_name']?>&birth=<?echo $board['birth']?>&handle=<?echo $board['handle']?>&gender=<?echo $board['gender']?>&member_code=<?echo $board['member_code']?>">확인</a></td>
...
-->
<!--				<audio id="audio" src="mp3/a_mp3.MP3" ></audio>-->
...
<!--		</div>-->
	...
	setInterval('reloadDivArea3()', 1000); //30초 후 새로고침
            ...
            <div class="container-fluid pt-4 px-4 mb-5"> 
                ...
                <div class="bg-light text-center rounded p-1" id="divReloadLayer3" style="background-color: white !important;">
                    <div class="d-flex align-items-center justify-content-between mb-4">
...
<!--                        <a href="">Show All</a>-->
                                        ...
                                        while($board = $stmt->fetch()){
                                            ...
                                            <tr>
                                                ...
                                                <?php if($board['finger_type'] == "심화"){ ?>
													<td><a href="http://aitms.co.kr/capfingers/result_private_final.php?member_code=<?php echo $board['member_code'] ?>"><i class="fa fa-print fa-2x" style="color: #FFAE00;"></i></a></td>
										
												<?php }else{?>
                                              <?php if($board['handle'] == "오른손"){
                                                    ?>
                                                    <td><a href="http://aitms.co.kr/capfingers/<?php echo $board['base_url'] ?>"><i class="fa fa-print fa-2x" style="color: #FFAE00;"></i></a></td>
                                                    <?}else{?>
                                                        <td><a href="http://aitms.co.kr/capfingers/<?php echo $board['base_url'] ?>"><i class="fa fa-print fa-2x" style="color: #FFAE00;"></i></a></td>
                                                        <?}?>
                                                ...
                                                if($board['handle'] == "오른손"){
                                                    ?>
                                                    <td><a href="http://aitms.co.kr/cms/result_private.php?member_code=<?php echo $board['member_code'] ?>"><i class="fa fa-print fa-2x" style="color: #FFAE00;"></i></a></td>
                                                                                                        <?}else{?>
                                                        <td><a href="http://aitms.co.kr/cms/result_private.php?member_code=<?php echo $board['member_code'] ?>"><i class="fa fa-print fa-2x" style="color: #FFAE00;"></i></a></td>
                                                        <?}?>
                                                        </tr>
            ...
            <!-- Footer Start -->
            <div class="container-fluid pt-4 px-4 " style="position: absolute;bottom: -22px;">
